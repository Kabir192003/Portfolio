        ...
        >
            ...
            <div className="container section">
                ...
                <div style={styles.contentSections} className="project-content-sections">
                    ...
                    <section style={styles.textSection}>
                        ...
                        <div style={styles.journeysContainer}>
                            {project.journeys && project.journeys.map((journey, idx) => {
                                ...
                                // Dynamic coloring based on persona archetype
                                let themeColor = '#046c4e';
                                let bgColor = '#e2f6ed';
                                if (journey.archetype.includes('Switcher')) {
                                    themeColor = '#44337a';
                                    bgColor = '#e9d8fd';
                                } else if (journey.archetype.includes('Seeker')) {
                                    themeColor = '#2a4365';
                                    bgColor = '#e2e8f0';
                                } else if (journey.archetype.includes('Recruiter')) {
                                    themeColor = '#22543d';
                                    bgColor = '#c6f6d5';
                                }
                                ...
                                return (
                                    <div key={idx} style={styles.journeyCard}>
                                        <div style={styles.journeyHeader}>
                                            <div style={{...styles.journeyAvatar, backgroundColor: bgColor, color: themeColor}}>{initials}</div>
                                            <div>
                    ...
                    {/* Initial Wireframes */}
                    <section style={styles.textSection}>
                        <h2 style={styles.sectionHeader} className="project-section-header">Initial Wireframes</h2>
